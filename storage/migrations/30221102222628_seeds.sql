...
INSERT INTO discounts (type, quantity_from, quantity_to, percentage, created_at, updated_at) VALUES ('land', 11, 20, 5.0, NOW(), NOW());
INSERT INTO discounts (type, quantity_from, quantity_to, percentage, created_at, updated_at) VALUES ('maritime', 11, 20, 3.0, NOW(), NOW());


-- Insertando datos para la tabla warehouses_and_ports
INSERT INTO warehouses_and_ports (id, type, name, location, created_at, updated_at) VALUES ('c3d4e5f6-a789-0123-c4d5-e6f7a8901234', 'land', 'Bodega Central', 'Location 1', NOW(), NOW());
INSERT INTO warehouses_and_ports (id, type, name, location, created_at, updated_at) VALUES ('d4e5f6a7-8901-2345-e6f7-a89012345678', 'maritime', 'Puerto Principal', 'Location 2', NOW(), NOW());

-- Insertando datos para la tabla product
INSERT INTO products (id, type, name, created_at, updated_at) VALUES ('e5f6a789-0123-4567-f8a9-0123456789ab', 'land', 'Producto Terrestre 1', NOW(), NOW());
INSERT INTO products (id, type, name, created_at, updated_at) VALUES ('f6a78901-2345-6789-a0bc-123456789abc', 'maritime', 'Producto Marítimo 1', NOW(), NOW());
...
DELETE FROM products WHERE id IN ('e5f6a789-0123-4567-f8a9-0123456789ab', 'f6a78901-2345-6789-a0bc-123456789abc');
